...
const Blogin = () => {
    ...
    async function submit(e){
        ...
        try{
            console.log(email);
            await axios.post("http://localhost:8000/user/login/client",{
                email,password
            })
            .then(res=>{
                if(res.data.message === "Login Success"){
                    globalvariable.currentBuyer = email;
                    history("/buyerDashboard");
                }else{
            ...
            <div className='grid grid-two-column'>
                ...
                <div className='login-form'>
                    <form method='post'>
                        <h2>Buyer Login</h2>
                        <br/><br/>
                        <h3>Don't have an account <NavLink to="/buyerSignup" >Sign Up</NavLink></h3>
                        <br/><br/>
                        <h3>Email</h3>
                        <br></br>
